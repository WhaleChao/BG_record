...
my$phone_img_folder="/data/data/com.termux/files/home/storage/shared/DCIM";  #fossify camera
...
system("magick", "$_", "-resize", "35%", "-strip", "-quality", "80", "-monitor", "./image/$img_name") == 0 or die "magick failed: $?";
print "proceed? [Enter=yes, Ctrl-C=abort] ";<STDIN>;
#>magic end

#<the line-number finding begin
my $line;
